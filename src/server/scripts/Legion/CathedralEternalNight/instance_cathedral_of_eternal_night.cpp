...
struct instance_cathedral_of_eternal_night : public InstanceScript
{
    instance_cathedral_of_eternal_night(Map* map) : InstanceScript(map)
    {
...
{
    RegisterInstanceScript(instance_cathedral_of_eternal_night, 1677);
}