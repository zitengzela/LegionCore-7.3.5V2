...
struct instance_black_rook_hold_dungeon : public InstanceScript
{
    instance_black_rook_hold_dungeon(Map* map) : InstanceScript(map)
    {
...
{
    RegisterInstanceScript(instance_black_rook_hold_dungeon, 1501);
}